...
pub unsafe fn adler32_x86_sse2(adler: u32, p: &[u8]) -> u32 {
    ...
    while data.len() >= 32 {
        ...
        s1 = ((s1 as u64 + s1_buf[0] as u64 + s1_buf[2] as u64) % DIVISOR as u64) as u32;
    ...
    while len >= 32 {
        ...
        if chunk_n >= 256 {
            ...
            while chunk_n >= 256 {
                ...
                let sum_sads_1 = _mm256_add_epi32(s12, s34);

                let s12_x2 = _mm256_add_epi32(s12, s12);
                let inc_part_1 = _mm256_add_epi32(_mm256_add_epi32(s12_x2, sad1), sad3);
                ...
                let sad5 = _mm256_sad_epu8(data_a_3, v_zero);
                let sad6 = _mm256_sad_epu8(data_b_3, v_zero);
                let sad7 = _mm256_sad_epu8(data_a_4, v_zero);
                let sad8 = _mm256_sad_epu8(data_b_4, v_zero);

                let s56 = _mm256_add_epi32(sad5, sad6);
                let s78 = _mm256_add_epi32(sad7, sad8);
                let sum_sads_2 = _mm256_add_epi32(s56, s78);

                let s56_x2 = _mm256_add_epi32(s56, s56);
                let inc_part_2 = _mm256_add_epi32(_mm256_add_epi32(s56_x2, sad5), sad7);

                let p5 = _mm256_maddubs_epi16(data_a_3, weights);
                let s_e = _mm256_madd_epi16(p5, ones_i16);
                v_s2_e = _mm256_add_epi32(v_s2_e, s_e);

                let p6 = _mm256_maddubs_epi16(data_b_3, weights);
                let s_f = _mm256_madd_epi16(p6, ones_i16);
                v_s2_f = _mm256_add_epi32(v_s2_f, s_f);

                let p7 = _mm256_maddubs_epi16(data_a_4, weights);
                let s_g = _mm256_madd_epi16(p7, ones_i16);
                v_s2_g = _mm256_add_epi32(v_s2_g, s_g);

                let p8 = _mm256_maddubs_epi16(data_b_4, weights);
                ...
                v_s1_acc = _mm256_add_epi32(v_s1_acc, v_s1);
                v_inc_acc_a = _mm256_add_epi32(v_inc_acc_a, inc_part_2);
                v_s1 = _mm256_add_epi32(v_s1, sum_sads_2);
        ...
        s1 = ((s1 as u64 + s1_buf[0] as u64 + s1_buf[2] as u64 + s1_buf[4] as u64 + s1_buf[6] as u64) % DIVISOR as u64) as u32;
...
pub unsafe fn adler32_x86_avx2_vnni(adler: u32, p: &[u8]) -> u32 {
    ...
    while data.len() >= 32 {
        ...
        s1 = ((s1 as u64 + s1_buf[0] as u64 + s1_buf[1] as u64 + s1_buf[2] as u64 + s1_buf[3] as u64) % DIVISOR as u64) as u32;
        let s2_sum = s2_buf[0] as u64 + s2_buf[1] as u64 + s2_buf[2] as u64 + s2_buf[3] as u64;
        s2 = ((s2 as u64 + s2_sum) % DIVISOR as u64) as u32;
...
pub unsafe fn adler32_x86_avx512_vnni(adler: u32, p: &[u8]) -> u32 {
    ...
    if data.len() >= 32 {
        ...
        s1 = ((s1 as u64 + sum_u as u64) % DIVISOR as u64) as u32;
