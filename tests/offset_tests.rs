...
#[test]
fn test_offset_54_pattern() {
    let mut compressor = Compressor::new(6).unwrap();
    let mut decompressor = Decompressor::new();

    // Pattern length 54. Offset 54.
    // Use unique bytes to ensure no internal matches.
    let pattern: Vec<u8> = b"ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqr"
        .iter()
        .cloned()
        .cycle()
        .take(10000)
...
#[test]
fn test_offset_34_pattern() {
    let mut compressor = Compressor::new(6).unwrap();
    let mut decompressor = Decompressor::new();

    // Pattern length 34. Offset 34.
    // Use unique bytes to ensure no internal matches.
    let pattern: Vec<u8> = b"ABCDEFGHIJKLMNOPQRSTUVWXYZ01234567"
        .iter()
        .cloned()
        .cycle()
        .take(10000)
...
#[test]
fn test_offset_62_pattern() {
    let mut compressor = Compressor::new(6).unwrap();
    let mut decompressor = Decompressor::new();

    // Pattern length 62. Offset 62.
    // Use unique bytes to ensure no internal matches.
    let pattern: Vec<u8> = b"ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz"
        .iter()
        .cloned()
        .cycle()
        .take(10000)
...
#[test]
fn test_offset_35_pattern() {
    let mut compressor = Compressor::new(6).unwrap();
    let mut decompressor = Decompressor::new();

    // Pattern length 35. Offset 35.
    // Use unique bytes to ensure no internal matches.
    let pattern: Vec<u8> = b"ABCDEFGHIJKLMNOPQRSTUVWXYZ012345678"
        .iter()
        .cloned()
        .cycle()
        .take(10000)
